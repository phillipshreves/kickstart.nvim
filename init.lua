...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- git
      vim.keymap.set('n', '<leader>gits', builtin.git_status, { desc = '[Git] [St]atus' })
      vim.keymap.set('n', '<leader>gitc', builtin.git_commits, { desc = '[Git] [C]ommits' })
      vim.keymap.set('n', '<leader>gitb', builtin.git_bcommits, { desc = '[Git] Commits [B]uffer' })
      vim.keymap.set('n', '<leader>gitr', builtin.git_branches, { desc = '[Git] B[r]anches' })
      vim.keymap.set('n', '<leader>gith', builtin.git_stash, { desc = '[Git] Stas[h]' })
    end,
  },
